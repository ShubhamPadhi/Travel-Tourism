...
public class Loading extends JFrame implements Runnable {
	...
	public Loading(String username) {
            ...
            JLabel lbl11=new JLabel("Welcome "+username+"");
            lbl11.setFont(new Font("Yu Gothic UI Semibold", Font.BOLD,40));
            lbl11.setForeground(new Color(160,82,45));
            lbl11.setBounds(30,700,70,750);
