...
public class CheckHotels extends JFrame implements Runnable {
    ...
    public void run(){
        String[] text=new String[]{"JW Marrriott Hotel","Madarin Oriental Hotel","Four Seasons Hotel","Raddison Blue Hotel","Classsio Hotel","The Bay Club Hotel","Breeze Blow Hotel","The Taj Hotel","Happy Morning Motel","River View Hotel"};
        try{
            for(int i=0;i<=9;i++){
    ...
    CheckHotels(){
       ...
       ImageIcon[] kimg=new ImageIcon[]{k1,k2,k3,k4,k5,k6,k7,k8,k9,k10};
        ...
        Jimg[i]=image[i].getImage().getScaledInstance(800,600,Image.SCALE_DEFAULT);
